...
const environments = [
    {
        ...
        hero: "/projects/3D-Immersive-Walkthroughs/DemonGate3.png",
        heroAlt: "Grey-box — side perspective of staircase and creature gate with demonic tendrils",
        draftLabel: "Grey-box Blockout",
        drafts: [
            { src: "/projects/3D-Immersive-Walkthroughs/DemonGate.png", alt: "Top-down render of the Demon Gate — a creature-formed arch surrounded by eldritch eyeball flora" },
            { src: "/projects/3D-Immersive-Walkthroughs/DemongateDraftLayout.png", alt: "Grey-box — ground-level view of stairs leading up to the creature arch gate" },
        ],
        gallery: [
            { src: "/projects/3D-Immersive-Walkthroughs/Demon%20Gate2.png", alt: "Demon Gate render — view 2" },
            { src: "/projects/3D-Immersive-Walkthroughs/DemonGate1.jpg", alt: "Demon Gate render — view 3" },
            { src: "/projects/3D-Immersive-Walkthroughs/Demongate4.png", alt: "Demon Gate render — view 4" },
            { src: "/projects/3D-Immersive-Walkthroughs/Demongate5.png", alt: "Demon Gate render — view 5" },
            { src: "/projects/3D-Immersive-Walkthroughs/Demongate6.png", alt: "Demon Gate render — view 6" },
        ],
    },
    {
        id: "02",
        ...
        hero: "/projects/3D-Immersive-Walkthroughs/EnchantedForest1.png",
        ...
        drafts: [
            { src: "/projects/3D-Immersive-Walkthroughs/EnchantedForest4-draftt.png", alt: "Grey-box blockout of the shrine building — column placement and facade proportions" },
            { src: "/projects/3D-Immersive-Walkthroughs/EnchantedForest7-DraftView02.png", alt: "Draft view 02 — alternate camera angle" },
        ],
        gallery: [
            { src: "/projects/3D-Immersive-Walkthroughs/EnchantedForesr2-potrait.png", alt: "Enchanted Forest — portrait format render" },
            { src: "/projects/3D-Immersive-Walkthroughs/EnchantedForest3-view2.png", alt: "Enchanted Forest — second camera position" },
            { src: "/projects/3D-Immersive-Walkthroughs/EnchantedForest6-draft.png", alt: "Enchanted Forest — draft lighting test" },
        ],
    },
    {
        id: "03",
        ...
        hero: "/projects/3D-Immersive-Walkthroughs/GasStationHoverBoard-zoomedout.png",
        ...
        drafts: [
            { src: "/projects/3D-Immersive-Walkthroughs/GasStation-Draft.png", alt: "Gas Station — scene blockout without materials" },
            { src: "/projects/3D-Immersive-Walkthroughs/GasStation-Draft-withmaterials.png", alt: "Gas Station — blockout with early material pass applied" },
        ],
        gallery: [
            { src: "/projects/3D-Immersive-Walkthroughs/GasStation-Board.png", alt: "Granny Art Petrol signage — octagonal vintage board close-up" },
            { src: "/projects/3D-Immersive-Walkthroughs/GasStation-Pump.png", alt: "Sci-fi electric pump prop — blue metallic unit with cable rigging" },
            { src: "/projects/3D-Immersive-Walkthroughs/GasStation-electriccharger-piluggedin.png", alt: "Yellow electric charger — plugged-in connector detail, machined mechanical design" },
            { src: "/projects/3D-Immersive-Walkthroughs/GasStation-electriccharger-view2.png", alt: "Electric charger — alternate angle" },
            { src: "/projects/3D-Immersive-Walkthroughs/GasStation-scifielectriccharger-prop.png", alt: "Sci-fi electric charger prop — isolated product render" },
            { src: "/projects/3D-Immersive-Walkthroughs/GasStationHpverboard-diaplay.png", alt: "Hoverboard display rack — forecourt prop" },
        ],
    },
    {
        id: "04",
        ...
        hero: "/projects/3D-Immersive-Walkthroughs/Temple-1.png",
        ...
        drafts: [
            { src: "/projects/3D-Immersive-Walkthroughs/Temple-2.png", alt: "Temple — carved ceiling panel close-up with heraldic medallion detail" },
            { src: "/projects/3D-Immersive-Walkthroughs/Temple-dome.png", alt: "Temple — plinth detail showing dense organic tentacular carved stonework beneath the classical exterior" },
        ],
        gallery: [],
    },
    {
        ...
        hero: "/projects/3D-Immersive-Walkthroughs/OldBuried-1.png",
        ...
        drafts: [
            { src: "/projects/3D-Immersive-Walkthroughs/OldBuried-4-grasslayout.png", alt: "Editor view — foliage scatter layout with face model and grass instance arrangement visible" },
        ],
        gallery: [
            { src: "/projects/3D-Immersive-Walkthroughs/OldBuried-2.png", alt: "Old Buried — alternate angle" },
            { src: "/projects/3D-Immersive-Walkthroughs/OldBuried-3.png", alt: "Old Buried — close detail" },
        ],
    },
];
