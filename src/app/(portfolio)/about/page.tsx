...
export default function About() {
    ...
    const expandedText1 = ` During my 4 years of bachelors, I participated in fashion shows and corporate events across FDDI and NIFT, which showed me that the most interesting design problems aren’t visual — they’re operational, and alongside working  as a Freelancer on 3D and AR experiences for event stalls pulled me toward spatial design.`;
